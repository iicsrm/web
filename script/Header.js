const generateHeader = () => {
    ...
    <header class="text-center py-8 flex justify-around content-start flex-col lg:flex-row">
            <a href="https://www.srmup.in/"><img src="./public/img/srm-logo.png" alt="SRM Logo" class="mx-auto w-48 md:w-64 md:max-w-xs"></a>
            ...
            <a href="/"><img id="club-logo" src="./public/img/logo.png" alt="Club Logo" class="mx-auto h-28 w-28 max-w-xs mt-6 lg:mt-0 rounded-full"></a>
